...
4. write smart and educational clues that point to the next stage. Optionally, write a multiple-chice question to double-check the discovery of the stage
