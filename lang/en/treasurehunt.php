...
$string['editactivity_help'] = 'You can find a step-by-step tutorial about creating treasurehunt activities at <a href="{$a}"> this page.</a>';
...
$string['hello'] = 'Hello';
$string['help_activitytutorialurl'] = 'Activity tutorial URL';
$string['help_activitytutorialurl_help'] = 'Link to the page explaining how to setup a Treasure Hunt activity';
$string['help_treasurehuntpresentationurl'] = 'Treasure Hunt presentation URL';
$string['help_treasurehuntpresentationurl_help'] = 'Link to the presentation of the Treasure Hunt';
